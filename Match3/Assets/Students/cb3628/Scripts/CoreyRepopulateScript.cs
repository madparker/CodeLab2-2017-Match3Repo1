...
public class CoreyRepopulateScript : MonoBehaviour {
	
	protected CoreyGameManagerScript gameManager; //reference to game manager

	public virtual void Start () {
		gameManager = GetComponent<CoreyGameManagerScript>(); //getting a refernece to GM component
	}
